using CareGiverSuperAdmin.Action_Filters;
using System;
...
public static class RBAC_ExtendedMethods
{
    ...
    public static bool HasPermissionWithUserId(this ControllerBase controller, string permission , string UserId)
    {
        bool bFound = false;
        try
        {
            //Check if the requesting user has the specified application permission...
            bFound = new RBACUserId(UserId).HasPermission(permission);
        }
        catch { }
        return bFound;
    }
